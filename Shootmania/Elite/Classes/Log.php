...
class Log
{
    ...
    const INFO   = 6;  // XML RPC Callbacks
    const DEBUG  = 7;  // SQL Queries
     ...
     * @return KLogger
     */
    public static function instance($logDirectory = false, $severity = false, $serverlogin)
    {
        if ($severity === false) {
        ...
        self::$instances[$logDirectory] = new self($logDirectory, $severity, $serverlogin);
     ...
     * @return void
     */
    public function __construct($logDirectory, $severity, $serverlogin)
    {
    ...
    {
        $this->log(print_r($line, true), self::DEBUG);
    }
    ...
    {
        $this->log(print_r($line,true), self::INFO, $args);
    }
